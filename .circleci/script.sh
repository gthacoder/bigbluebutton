...
docker exec $container bash -c "cd bigbluebutton/bigbluebutton-html5 && ROOT_URL=http://127.0.0.1/html5client NODE_ENV=development METEOR_ALLOW_SUPERUSER=true meteor &"
