...
if not FileTest.directory?(target_dir)
  ...
  if !Dir["#{raw_archive_dir}/video/*"].empty?    
    ...
    BigBlueButton.process_sign_language_videos(target_dir, temp_dir, meeting_id, presentation_props['video_output_width'], presentation_props['video_output_height'], presentation_props['sign_language_user'])
  else    
    BigBlueButton::AudioProcessor.process("#{temp_dir}/#{meeting_id}", "#{target_dir}/audio.ogg")
  end
